...
def main(mode, args):
    ...
    if args.ckpt is None:
        assert args.model == "ComboStoc-XL/2", "Only ComboStoc-XL/2 models are available for auto-download."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default=None,
                        help="Optional path to a ComboStoc checkpoint (default: auto-download a pre-trained ComboStoc-XL/2 model).")
